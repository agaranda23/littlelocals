...
const ALWAYS_AVAILABLE_TYPES = new Set([
  "Park", "Playground", "Nature", "Garden", "Nursery",
]);
    ...
    <div onClick={handleClick} style={{ background: "white", borderRadius: 16, marginBottom: 12, cursor: "pointer", boxShadow: "0 12px 32px rgba(0,0,0,0.08)", border: isExpired ? "1px solid #D1D5DB" : "1px solid #EFEFEF", overflow: "hidden", transition: "transform 0.12s ease, box-shadow 0.12s ease", opacity: isExpired ? 0.6 : 1, filter: isExpired ? "grayscale(0.7)" : "none", position: "relative" }}>
      ...
      <div style={{ padding: "10px 14px 13px", marginTop: 2 }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 4, marginTop: 2, marginBottom: 2 }}>
          {socialProof && <div style={{ fontSize: 11, color: "#78350F", fontWeight: 600, background: "#FFFBEB", padding: "1px 6px", borderRadius: 5, border: "1px solid #F59E0B" }}>{socialProof}</div>}
          {item.worthJourney && <div style={{ fontSize: 11, color: "#1D4ED8", fontWeight: 700, background: "#EFF6FF", padding: "1px 6px", borderRadius: 5, border: "1px solid #BFDBFE" }}>🚗 Worth the journey</div>}
        </div>
