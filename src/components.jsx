      ...
      <div style={{ padding: 20 }}>
        ...
        {item.cta && item.cta.url && item.website && item.website !== item.cta.url && (
          <div style={{ marginTop: 8 }}>
            <button onClick={(e) => { e.stopPropagation(); openExternalWebsite(item.website); }} style={{ width: "100%", padding: 12, borderRadius: 12, border: "none", background: "#D4732A", color: "white", fontSize: 17, fontWeight: 900, cursor: "pointer", fontFamily: "inherit" }}>
              🔗 More info / Bookings
            </button>
          </div>
        )}
