...
const BottomNav = () => (
  <div style={{ position: "fixed", bottom: 0, left: "50%", transform: "translateX(-50%)", width: "100%", maxWidth: 480, height: 68, background: "transparent", display: "flex", zIndex: 1000, paddingBottom: 4 }}>
    {[
  ...
  if (val.length === 1) {
    ...
    setAgeFilter("all");
      ...
      {page === 1 && !search && !showFavourites && (() => {
        ...
        const area = areaFilter !== "All Areas" ? areaFilter : "Ealing";
        return (
          <div style={{ padding: "16px 20px 4px", borderBottom: "1px solid #F3F4F6", marginBottom: 4 }}>
